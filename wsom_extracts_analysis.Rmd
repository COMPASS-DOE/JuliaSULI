...
ggplot(wsom_extracts) +
  ...
  labs(x = "Location", y = "WSOC Concentration (mg/g soil)")
...
ggplot(wsom_extracts) +
  geom_boxplot(aes(x = transect_location, y = wsoc_conc_field, fill = transect_location),
               show.legend = FALSE) +
  scale_fill_manual(values = palette) +
  labs(x = "Location", y = "WSOC Concentration (mg/g field moist soil)")
...
friedman.test(wsoc_conc ~ transect_location | region, data = wsom_extracts)
